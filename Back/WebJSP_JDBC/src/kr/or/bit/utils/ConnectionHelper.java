	 ...
	 public static Connection getConnection(String dsn) { // oracle , mysql ...
		 ...
		 try {
			 if(dsn.equals("oracle")) {
				    ...
				    conn = DriverManager.getConnection("jdbc:mysql://192.168.0.218:3306/smpledb?characterEncoding=UTF-8&serverTimezone=UTC&useSSL=true","bituser","1004");
			 }
		 }catch (Exception e) {
 ...
 try {
	 if(dsn.equals("oracle")) {
		    ...
		    conn = DriverManager.getConnection(""
		    		+ "jdbc:mysql://192.168.0.30:3306/sampledb?characterEncoding=UTF-8&serverTimezone=UTC&useSSL=true",id,pwd);
		 }
	 }catch (Exception e) {
		System.out.println(e.getMessage());
	 }
