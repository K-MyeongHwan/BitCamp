...
public class RegisterFrontController extends HttpServlet {
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * 1. command 방식 : servlet.do?cmd=login&id=kglim&pwd=1004 > cmd >
		 * if(cmd.equals("login")) 2. url 방식 : login.do?id=kglim&pwd=1004 : login.do >
		 * url 주소로 요청을 판단
		 */
		 ...
		 * /WebServlet_8_Member_Model2_Mvc_Url command : /Register.do
		 * 
		 */
		// 3. 요청판단, 비즈니스 서비스 만들기
		String viewpage = "";
		if (command.equals("/Register.do")) { // ?cmd=register
			// 화면전달
