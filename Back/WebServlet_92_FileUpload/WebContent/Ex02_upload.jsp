...
<%
	...
	MultipartRequest multi = new MultipartRequest(
				...
				size, //10m
				"UTF-8",
				new DefaultFileRenamePolicy() //파일 중복(upload > a.txt > a.txt 업로드면 충돌  a_1.txt)
			); //파일 업로드 완료(6줄)
		//여기까지 코드가 서버에 upload폴더에 파일이 저장
		//C:\Users\333vn\OneDrive\바탕 화면\WEB\Web(Back)\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebServlet_92_FileUpload
		//자료실 2가지
		//1서버에 파일 업로드
		
		//2작성자, 제목 , 내용 , 파일명, 파일 사이즈 DB Insert 하는 작업이 필요
		//2번 작업 text MultipartRequest 가져오기
		...
		*/
		String file2 = (String)filenames.nextElement(); //filename2
		...
		//a.jpg 업로드
		//orifilename2 > a.jpg
		//filename2 ( 정책의 의해) > a1.jpg
		
		String file1 = (String)filenames.nextElement(); //filename2
		...
		//DB연결하기
		//insert into fileboard(title ..... filename) values(?,?,?....) 실행하고
		//목록보기 이동한결과
